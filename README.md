...
Things to do:
- establish formality level - DONE (semi-formal with a hint of familiarity)
- learn technologies used - DONE (RoR for the backend and coffeescript/JS for the frontend, database is postgress, servers will be hosted in Europe)
- cooperate with designer more - DONE
- check the devices - mobile or not - DONE (tablets/smartphones)
...
### Municipial organizations. Civil Servants. Open-minded managers. Scrum masters. Leading developers. 
